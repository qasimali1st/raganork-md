...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/d6b48bca7758119ef0652.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~15aaffcfe2f40f73e4470bb5e65b261b:4d314c754b48376a7757303d').trim() || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'KHARAL-MD-V5;QASIM ALI;0;https://telegra.ph/file/d6b48bca7758119ef0652.jpg;https://whatsapp.com/channel/0029VagJIAr3bbVBCpEkAM07',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '92,94,234',
    ...
    SUDO: process.env.SUDO || "923444844060",
